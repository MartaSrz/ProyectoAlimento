...
public class ResultadosUser {
	 ...
	 */
	public static void resultados(Persona usuario) { /*accci√≥n para arrancar la tercera ventana*/
	...
	private void initialize() {
		...
		JLabel lblTitulo = new JLabel("Estos son tus resultados respecto al C·lculo Nutritivo :D!");
		...
		JLabel lblReferenciaImagen = new JLabel("Esta imagen te ayudar· a orientarte dependiendo de tu resultado.");
