/**
 *Clase Main.
 *Esta clase ha sido creada para pedirle la informaciÃ³n necesaria al usuario, la cual
 *serÃ¡ clave para calcular el resultado final. eEsta inforrmaciÃ³n serÃ¡ mandada a la clase persona.
 */
...
public class ProyectoAlimento{
	...
	private void initialize() {
		...
		/**
		 * CreaciÃ³n de Grupo de Botones.
		 * AÃ±adimos los RadioButton al grupo creado anteriormente
		 */
		...
		btnContinuar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (txtNombre.getText().equals("") || txtNombre.getText().equals(DEFECTO_TXTNOMBRE)) {
					...
					ValoresNutritivos.arrancar(usuario); /*Se arranca ValoresNutritivos pasÃ¡ndole como parametro el objeto de tipo Persona*/
				}
			}
		});
